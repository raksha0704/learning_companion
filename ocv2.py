...
'''
crop_img = cv2.imread("C:\\Users\\rohan\\Desktop\\project\\FinalYearProj\\IMG_20170131_221525.jpg")
cv2.namedWindow( 'init', cv2.WINDOW_NORMAL )
crop_img = cv2.resize(crop_img, (960, 540))                    # Resize image
cv2.imshow('init',crop_img)
cv2.waitKey(0)
img = crop_img
cv2.namedWindow( 'init1', cv2.WINDOW_NORMAL )
img = cv2.resize(img, (960, 540))                    # Resize image
cv2.imshow('init1',img)
cv2.waitKey(0)
cv2.destroyAllWindows()
'''

crop_img = cv2.imread("C:\\Users\\rohan\\Desktop\\project\\FinalYearProj\\IMG_20170131_221450.jpg")
cv2.namedWindow( 'init', cv2.WINDOW_NORMAL )
crop_img = cv2.resize(crop_img, (960, 540))                    # Resize image
cv2.imshow('init',crop_img)
cv2.waitKey(0)
